...
from .views import Tradespeople_view, TradeSpecialty_view, City_view, Country_view, TradespeopleViewSet, jobattachments_view,\
      jobs_view, user_view, skills_view,usersViewSet 
