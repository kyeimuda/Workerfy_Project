"""
Django settings for Workerfy project.
...
SECRET_KEY = 'django-insecure-uw+#r4xtx&#u)4j0+b@66v1u+4s(474f@k60)knrkscullhz$2'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'Discover/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Workerfy.wsgi.application'
